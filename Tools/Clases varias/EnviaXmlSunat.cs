...
namespace Tools
{
    internal class EnviaXmlSunat
    {
        ...
        public SunatBeta.billServiceClient ObjetoSunat(string url, string user, string pass)
        {
            ...
            SunatBeta.billServiceClient clientOSE = new SunatBeta.billServiceClient(basicHttpBinding, endPointURL);
